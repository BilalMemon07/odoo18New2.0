...
class SaleOrderLine(models.Model):
    ...
    def _get_product_price_context(self):
        ...
        result['manual_currency_rate'] = (1 / self.order_id.sale_manual_currency_rate)
        return result
    ...
    def product_uom_change(self):
        ...
        if self.order_id.pricelist_id and self.order_id.partner_id:
            ...
            if self.order_id.sale_manual_currency_rate_active:
                sale_manual_currency_rate = self.product_id.lst_price * (1 / self.order_id.sale_manual_currency_rate)
